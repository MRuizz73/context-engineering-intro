...
function destinoEmail(d) {
  ...
  return "⚠️ chófer sin email cargado";
}
...
function abrirFormChofer() {
  cerrarForms();
  document.getElementById("titulo-form-chofer").textContent = "Nuevo chófer";
...
function editarChofer(json) {
  ...
  abrirFormChofer();
  document.getElementById("titulo-form-chofer").textContent = "Editar chófer";
